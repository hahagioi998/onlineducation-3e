      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="https://github.com/573e" title="GitHub" target="_blank">GitHub</a>
            </li>
          </ul>
          <div class="clear"></div>
        </div>
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                <a href="https://573e.github.io/about/" title="关于我们" target="_blank">关于我们</a>|
                <a href="https://573e.github.io/about/" title="联系我们" target="_blank">联系我们</a>|
                <a href="#" title="帮助中心" target="_blank">帮助中心</a>|
                <a href="#" title="资源下载" target="_blank">资源下载</a>|
                <span>服务热线：183****0892</span>
                <span>Email：hzlei@foxmail.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2020课程版权均归善逸学院所有 京ICP备17055252号</span>
              </section>
            </section>
          </section>
